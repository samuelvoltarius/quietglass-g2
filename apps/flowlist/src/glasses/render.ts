 ...
 */
export async function createPage(bridge: EvenAppBridge, view: FlowView): Promise<RenderResult> {
...
export async function updatePage(bridge: EvenAppBridge, view: FlowView): Promise<RenderResult> {
