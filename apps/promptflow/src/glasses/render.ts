...
/**
 * Renders the prompter onto the G2.
 *
...
export function buildPage(view: PrompterView): CreateStartUpPageContainer {
 ...
 */
export async function createPage(bridge: EvenAppBridge, view: PrompterView): Promise<RenderResult> {
...
export async function updatePage(bridge: EvenAppBridge, view: PrompterView): Promise<RenderResult> {
