...
/**
 * Renders the status dashboard onto the G2.
 *
...
export function buildPage(view: StatusView): CreateStartUpPageContainer {
 ...
 */
export async function createPage(bridge: EvenAppBridge, view: StatusView): Promise<RenderResult> {
...
export async function updatePage(bridge: EvenAppBridge, view: StatusView): Promise<RenderResult> {
