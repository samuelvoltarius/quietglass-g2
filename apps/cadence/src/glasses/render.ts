...
import type { CadenceView } from "./view";

/**
 * Renders the metronome onto the G2.
 *
...
export function buildPage(view: CadenceView): CreateStartUpPageContainer {
 ...
 */
export async function createPage(bridge: EvenAppBridge, view: CadenceView): Promise<RenderResult> {
...
export async function updatePage(bridge: EvenAppBridge, view: CadenceView): Promise<RenderResult> {
